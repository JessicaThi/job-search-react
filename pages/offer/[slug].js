    ...
    <main className="container max-w-screen-xl mx-auto px-5">
      ...
      <div className="md:flex">
        <aside className="md:w-1/4 md:pr-20 pb-6 md:pb-0">
          ...
          {jobOffer ? 
          <p className="font-roboto font-normal text-blue-900" dangerouslySetInnerHTML={{__html:jobOffer.how_to_apply}}></p> : ''}
        </aside>
        <div className="md:w-3/4 pb-6">
          {jobOffer ? 
          <p className="text-2xl font-roboto font-bold text-blue-900 py-2">{jobOffer.title}<span className="ml-3 text-xs font-roboto font-bold text-blue-900 align-middle border border-blue-900 rounded py-1 px-2">{jobOffer.type}</span></p> : ''}
          ...
          <div className="flex py-6">
            {jobOffer ? 
            <div className="w-11 h-11 mr-2 flex justify-center items-center rounded">
          ...
          {jobOffer ? 
          <div className="font-roboto font-normal text-blue-900" dangerouslySetInnerHTML={{__html:jobOffer.description}}></div> : ''}
        </div>
      </div>
    </main>
  )
